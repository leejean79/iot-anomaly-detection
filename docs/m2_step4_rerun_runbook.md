...
重发在此暴露）；③ 边界对齐（最早≈03-01 00:00、最晚≈03-31 23:59:50，容差默认 120s——实测数据集三月最后
一轮固定在 23:58:30，比名义右界早 80s，属月末自然缺口而非截断，故容差按真实边界校准）；④ 冻结落第八天
（八台标准化冻结时刻落在第 8 天区间——压缩/重发会提前到第 4 天，本条专抓上轮的病）。
